...
const char* token_type_name(TokenType t) {
    switch (t) {
        case TokenType::Vowel:            return "Vowel";
        case TokenType::Consonant:        return "Consonant";
        case TokenType::VirtualConsonant: return "VirtualConsonant";
        case TokenType::Accent:           return "Accent";
        case TokenType::Hasanta:          return "Hasanta";
        case TokenType::ZWNJ:             return "ZWNJ";
