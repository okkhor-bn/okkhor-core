...
int main() {
  ...
  testing::check(
      "Latin -> Bangla: explicit hasanta",
      engine.transliterate_latin_to_bangla("k,."),
      "ক্");

  testing::check(
      "Latin -> Bangla: hasanta + ZWNJ macro",
      engine.transliterate_latin_to_bangla("k,,"),
      "ক্‌");
  ...
  testing::check(
      "Bangla -> Latin: explicit hasanta",
      engine.transliterate_bangla_to_latin("ক্"),
      "k,.");

  testing::check(
      "Bangla -> Latin: hasanta + ZWNJ macro",
      engine.transliterate_bangla_to_latin("ক্‌"),
      "k,,");

  testing::check(
      "Bangla -> Latin: ZWNJ",
      engine.transliterate_bangla_to_latin("ক\u200C"),
      "k|");
  ...
  testing::check(
      "Round trip: hasanta + ZWNJ",
      engine.transliterate_latin_to_bangla(
          engine.transliterate_bangla_to_latin("ক্‌")),
      "ক্‌");

  testing::check(
      "Round trip: consonant + hasanta + consonant",
      engine.transliterate_latin_to_bangla(
  ...
  testing::check(
      "Round trip: simple conjunct",
      engine.transliterate_latin_to_bangla(
          engine.transliterate_bangla_to_latin("ক্ন")),
      "ক্ন");

  testing::check(
      "Round trip: conjunct with vowel",
      engine.transliterate_latin_to_bangla(
          engine.transliterate_bangla_to_latin("ক্না")),
      "ক্না");

  testing::check(
      "Round trip: three-consonant conjunct",
      engine.transliterate_latin_to_bangla(
  ...
  testing::check(
      "Round trip: conjunct + chandrabindu",
      engine.transliterate_latin_to_bangla(
  ...
  const std::string hard =
      "ক্ষ্ম্যজ্ঞ্যন্ত্‌র্য্যশ্চ্ছ্বঙ্ক্ষ্ট্র্দ্ধ্ব্যাঁক্‌ন্‌ম্গ্ন্ত্র্যৌক্ক্হৃঙ্ঘ্ন্য";
